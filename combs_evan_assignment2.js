...
//final output
Write(ColonelSpeachIntro(generals[1], strategist));
...
Write('With all five colonels in the tent, ' + generals[1] + ' begins to talk. "We are going to battle ' + day + ' colonels. This is a dangerous plan, but it is the only way we will win this battle');
